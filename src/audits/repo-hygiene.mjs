...
export const checks = [
  ...
  },
  {
    ...
    type: 'file',
    description: 'Containerization provides reproducible environments for agents',
  },
  {
    id: 'task-runner',
    label: 'Makefile / Justfile / Taskfile',
    section,
    weight: 2,
    paths: ['Makefile', 'justfile', 'Justfile', 'Taskfile.yml', 'Taskfile.yaml'],
    type: 'file',
    description: 'Task runner gives agents discoverable project commands',
  },
  {
    id: 'type-safety',
    label: 'Type safety config',
    section,
    weight: 3,
    paths: ['tsconfig.json', 'jsconfig.json', 'mypy.ini', '.mypy.ini', 'pyrightconfig.json', 'pyproject.toml'],
    type: 'file',
    description: 'Type checking helps agents generate correct, type-safe code',
  },
  {
    id: 'version-pinning',
    label: 'Runtime version pinning',
    section,
    weight: 2,
    paths: [
      '.nvmrc',
